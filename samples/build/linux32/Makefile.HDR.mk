...
ProjectName = HDR
HDR_cppfiles   += ./../../es3-kepler/HDR/BlurShaderGenerator.cpp
HDR_cppfiles   += ./../../es3-kepler/HDR/FileLoader.cpp
HDR_cppfiles   += ./../../es3-kepler/HDR/HDR.cpp
HDR_cppfiles   += ./../../es3-kepler/HDR/HDRImages.cpp
HDR_cppfiles   += ./../../es3-kepler/HDR/RenderTexture.cpp
HDR_cppfiles   += ./../../es3-kepler/HDR/ShaderObject.cpp
HDR_cppfiles   += ./../../es3-kepler/HDR/VertexBufferObject.cpp
HDR_cppfiles   += ./../../es3-kepler/HDR/rgbe.cpp
...
HDR_debug_hpaths    := 
HDR_debug_hpaths    += ./../../es3-kepler/HDR
...
HDR_debug_cflags  += -Wall -Wextra -Wno-unused-parameter -Wno-ignored-qualifiers -Wno-unused-but-set-variable -Wno-switch -Wno-unused-variable -Wno-unused-function
HDR_debug_cflags  += -malign-double
HDR_debug_cflags  += -g
HDR_debug_cppflags	:= $(HDR_debug_common_cflags)
HDR_debug_cppflags  += -Wall -Wextra -Wno-unused-parameter -Wno-ignored-qualifiers -Wno-unused-but-set-variable -Wno-switch -Wno-unused-variable -Wno-unused-function
...
clean_HDR_debug: 
	$(SILENT_FLAG)$(ECHO) clean HDR debug
	$(SILENT_FLAG)$(RMDIR) $(HDR_debug_objsdir)
	$(SILENT_FLAG)$(RMDIR) $(HDR_debug_bin)
...
$(HDR_debug_bin): $(HDR_debug_obj) build_Half_debug build_NvAppBase_debug build_NvAssetLoader_debug build_NvGamepad_debug build_NvGLUtils_debug build_NvModel_debug build_NvUI_debug 
	$(SILENT_FLAG)mkdir -p `dirname ./../../bin/linux32/HDRD`
	$(SILENT_FLAG)$(CCLD) $(HDR_debug_obj) $(HDR_debug_lflags) -o $(HDR_debug_bin) 
	$(SILENT_FLAG)$(ECHO) building $@ complete!

HDR_debug_DEPDIR = $(dir $(@))/$(*F)
$(HDR_debug_cpp_o): $(HDR_debug_objsdir)/%.o:
	$(SILENT_FLAG)$(ECHO) HDR: compiling debug $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(HDR_debug_objsdir),, $@))), $(HDR_cppfiles))...
	$(SILENT_FLAG)mkdir -p $(dir $(@))
	$(SILENT_FLAG)$(CXX) $(HDR_debug_cppflags) -c $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(HDR_debug_objsdir),, $@))), $(HDR_cppfiles)) -o $@
	$(SILENT_FLAG)mkdir -p $(dir $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(HDR_debug_objsdir),, $@))), $(HDR_cppfiles))))))
	$(SILENT_FLAG)cp $(HDR_debug_DEPDIR).d $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(HDR_debug_objsdir),, $@))), $(HDR_cppfiles))))).debug.P; \
	  sed -e 's/#.*//' -e 's/^[^:]*: *//' -e 's/ *\\$$//' \
...
$(HDR_debug_cc_o): $(HDR_debug_objsdir)/%.o:
	$(SILENT_FLAG)$(ECHO) HDR: compiling debug $(filter %$(strip $(subst .cc.o,.cc, $(subst $(HDR_debug_objsdir),, $@))), $(HDR_ccfiles))...
	$(SILENT_FLAG)mkdir -p $(dir $(@))
	$(SILENT_FLAG)$(CXX) $(HDR_debug_cppflags) -c $(filter %$(strip $(subst .cc.o,.cc, $(subst $(HDR_debug_objsdir),, $@))), $(HDR_ccfiles)) -o $@
	$(SILENT_FLAG)mkdir -p $(dir $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .cc.o,.cc, $(subst $(HDR_debug_objsdir),, $@))), $(HDR_ccfiles))))))
	$(SILENT_FLAG)cp $(HDR_debug_DEPDIR).d $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .cc.o,.cc, $(subst $(HDR_debug_objsdir),, $@))), $(HDR_ccfiles))))).debug.P; \
	  sed -e 's/#.*//' -e 's/^[^:]*: *//' -e 's/ *\\$$//' \
...
$(HDR_debug_c_o): $(HDR_debug_objsdir)/%.o:
	$(SILENT_FLAG)$(ECHO) HDR: compiling debug $(filter %$(strip $(subst .c.o,.c, $(subst $(HDR_debug_objsdir),, $@))), $(HDR_cfiles))...
	$(SILENT_FLAG)mkdir -p $(dir $(@))
	$(SILENT_FLAG)$(CC) $(HDR_debug_cflags) -c $(filter %$(strip $(subst .c.o,.c, $(subst $(HDR_debug_objsdir),, $@))), $(HDR_cfiles)) -o $@ 
	$(SILENT_FLAG)mkdir -p $(dir $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .c.o,.c, $(subst $(HDR_debug_objsdir),, $@))), $(HDR_cfiles))))))
	$(SILENT_FLAG)cp $(HDR_debug_DEPDIR).d $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .c.o,.c, $(subst $(HDR_debug_objsdir),, $@))), $(HDR_cfiles))))).debug.P; \
	  sed -e 's/#.*//' -e 's/^[^:]*: *//' -e 's/ *\\$$//' \
...
HDR_release_hpaths    := 
HDR_release_hpaths    += ./../../es3-kepler/HDR
...
HDR_release_cflags  += -Wall -Wextra -Wno-unused-parameter -Wno-ignored-qualifiers -Wno-unused-but-set-variable -Wno-switch -Wno-unused-variable -Wno-unused-function
HDR_release_cflags  += -malign-double
HDR_release_cflags  += -O2
HDR_release_cppflags	:= $(HDR_release_common_cflags)
HDR_release_cppflags  += -Wall -Wextra -Wno-unused-parameter -Wno-ignored-qualifiers -Wno-unused-but-set-variable -Wno-switch -Wno-unused-variable -Wno-unused-function
...
clean_HDR_release: 
	$(SILENT_FLAG)$(ECHO) clean HDR release
	$(SILENT_FLAG)$(RMDIR) $(HDR_release_objsdir)
	$(SILENT_FLAG)$(RMDIR) $(HDR_release_bin)
...
$(HDR_release_bin): $(HDR_release_obj) build_Half_release build_NvAppBase_release build_NvAssetLoader_release build_NvGamepad_release build_NvGLUtils_release build_NvModel_release build_NvUI_release 
	$(SILENT_FLAG)mkdir -p `dirname ./../../bin/linux32/HDR`
	$(SILENT_FLAG)$(CCLD) $(HDR_release_obj) $(HDR_release_lflags) -o $(HDR_release_bin) 
	$(SILENT_FLAG)$(ECHO) building $@ complete!

HDR_release_DEPDIR = $(dir $(@))/$(*F)
$(HDR_release_cpp_o): $(HDR_release_objsdir)/%.o:
	$(SILENT_FLAG)$(ECHO) HDR: compiling release $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(HDR_release_objsdir),, $@))), $(HDR_cppfiles))...
	$(SILENT_FLAG)mkdir -p $(dir $(@))
	$(SILENT_FLAG)$(CXX) $(HDR_release_cppflags) -c $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(HDR_release_objsdir),, $@))), $(HDR_cppfiles)) -o $@
	$(SILENT_FLAG)mkdir -p $(dir $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(HDR_release_objsdir),, $@))), $(HDR_cppfiles))))))
	$(SILENT_FLAG)cp $(HDR_release_DEPDIR).d $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(HDR_release_objsdir),, $@))), $(HDR_cppfiles))))).release.P; \
	  sed -e 's/#.*//' -e 's/^[^:]*: *//' -e 's/ *\\$$//' \
...
$(HDR_release_cc_o): $(HDR_release_objsdir)/%.o:
	$(SILENT_FLAG)$(ECHO) HDR: compiling release $(filter %$(strip $(subst .cc.o,.cc, $(subst $(HDR_release_objsdir),, $@))), $(HDR_ccfiles))...
	$(SILENT_FLAG)mkdir -p $(dir $(@))
	$(SILENT_FLAG)$(CXX) $(HDR_release_cppflags) -c $(filter %$(strip $(subst .cc.o,.cc, $(subst $(HDR_release_objsdir),, $@))), $(HDR_ccfiles)) -o $@
	$(SILENT_FLAG)mkdir -p $(dir $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .cc.o,.cc, $(subst $(HDR_release_objsdir),, $@))), $(HDR_ccfiles))))))
	$(SILENT_FLAG)cp $(HDR_release_DEPDIR).d $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .cc.o,.cc, $(subst $(HDR_release_objsdir),, $@))), $(HDR_ccfiles))))).release.P; \
	  sed -e 's/#.*//' -e 's/^[^:]*: *//' -e 's/ *\\$$//' \
...
$(HDR_release_c_o): $(HDR_release_objsdir)/%.o:
	$(SILENT_FLAG)$(ECHO) HDR: compiling release $(filter %$(strip $(subst .c.o,.c, $(subst $(HDR_release_objsdir),, $@))), $(HDR_cfiles))...
	$(SILENT_FLAG)mkdir -p $(dir $(@))
	$(SILENT_FLAG)$(CC) $(HDR_release_cflags) -c $(filter %$(strip $(subst .c.o,.c, $(subst $(HDR_release_objsdir),, $@))), $(HDR_cfiles)) -o $@ 
	$(SILENT_FLAG)mkdir -p $(dir $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .c.o,.c, $(subst $(HDR_release_objsdir),, $@))), $(HDR_cfiles))))))
	$(SILENT_FLAG)cp $(HDR_release_DEPDIR).d $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .c.o,.c, $(subst $(HDR_release_objsdir),, $@))), $(HDR_cfiles))))).release.P; \
	  sed -e 's/#.*//' -e 's/^[^:]*: *//' -e 's/ *\\$$//' \
